...
class Student(Model):
    ...
    """
    def __init__(self, student_id: int=None, first_name: str=None, last_name: str=None, grade_records: List[str]=None):  # noqa: E501
        ...
        :type grade_records: List[str]
        """
        self.swagger_types = {
            'student_id': int,
            'first_name': str,
            'last_name': str,
            'grade_records': List[str]
        }
    ...
    @property
    def grade_records(self) -> List[str]:
    ...
    def grade_records(self, grade_records: List[str]):
